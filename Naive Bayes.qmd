...
```{r}
nb_model <- naive_Bayes(smoothness=1.6, Laplace = 10) %>% #smoothness - how wiggly is the resulting density, laplace - how much predictions are all being pulled into 0.5
...
vroom_write(x=kaggle_submission, file="./Naive_Bayes_Predictions.csv", delim=",")
```
